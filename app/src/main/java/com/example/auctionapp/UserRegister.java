    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UserRegister.this, UserSignin.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        reference = FirebaseDatabase.getInstance().getReference().child(UserRegister.RIDER_USERS).child(userId);
